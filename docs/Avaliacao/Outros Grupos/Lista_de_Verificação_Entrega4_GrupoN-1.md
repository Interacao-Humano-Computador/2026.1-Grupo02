...
|:--:|:--------:|:--------|:---------------------------------:|:--------------------------------:|
| C1 | Planejamento da Avaliação (Storyboard e Análise de Tarefas) | O planejamento da avaliação segue o Framework DECIDE? | Sim | 1.0 |
| C2 | Planejamento da Avaliação (Storyboard e Análise de Tarefas) | Descreve o(s) objetivo(s) da avaliação? | Sim | 1.0 |
| C3 | Planejamento da Avaliação (Storyboard e Análise de Tarefas) | Os métodos de avaliação a serem utilizados estão definidos? | Sim | 1.0 |
| C4 | Planejamento da Avaliação (Storyboard e Análise de Tarefas) | As questões práticas da avaliação estão descritas (recrutamento, equipamentos, prazos, orçamento)? | Sim | 1.0 |
| C5 | Planejamento da Avaliação (Storyboard e Análise de Tarefas) | As questões éticas estão contempladas (respeito aos participantes, termos de consentimento)? | Sim | 1.0 |
| C6 | Planejamento da Avaliação (Storyboard e Análise de Tarefas) | Há um cronograma com data, horário e local para realização da avaliação? | Sim | 1.0 |
| C7 | Planejamento da Avaliação (Storyboard e Análise de Tarefas) | A definição do teste piloto e data para sua realização estão presentes? | Sim | 1.0 |
| C8 | Planejamento da Avaliação (Storyboard e Análise de Tarefas) | As metas de usabilidade que devem ser alcançadas no projeto ou os objetivos de uma avaliação de IHC estão descritos? | Sim | 1.0 |
| C9 | Planejamento da Avaliação (Storyboard e Análise de Tarefas) | A razão da seleção das metas de usabilidade está justificada? | Sim | 1.0 |
| C10 | Planejamento do Relato dos Resultados (Storyboard) | A estrutura do relatório do resultado da avaliação está definida (objetivos, método, participantes, tarefas, problemas encontrados)? | Sim | 1.0 |
| C11 | Planejamento do Relato dos Resultados (Storyboard) | Está previsto que o resultado do teste piloto não será apresentado no resultado final da avaliação? | Sim | 1.0 |
| C12 | Planejamento do Relato dos Resultados (Storyboard) | Os itens que o avaliador deve realizar/anotar durante a avaliação estão listados (listar problemas, priorizar correção)? | Sim | 1.0 |
| C13 | Storyboard e HTA (Análise de Tarefas) | Cada desenho do Storyboard está relacionado a uma especificação do artefato da Análise de Tarefas (HTA)? | Sim | 1.0 |
| C14 | Storyboard e HTA (Análise de Tarefas) | A quantidade de storyboards é igual à quantidade de integrantes do grupo? | Sim | 1.0 |
...
| 23/06/2026 | 2.0 | Revisão das listas com adições de seção para cada artefato | Samuel Felipe | Guilherme |

...
<div style="text-align: left">
<p>Tabela 2: Etapas do Framework DECIDE (Fonte: adaptado de BARBOSA et al., 2021, p. 280).</p>
</div>
...
1. **Verificar a apropriação da tecnologia pelos usuários** — avaliar se as tarefas modeladas refletem adequadamente como os usuários reais realizam suas atividades, suas necessidades e seus objetivos ao interagir com o sistema.

...
Este documento centraliza o acesso a todos os relatos de avaliação produzidos pelo Grupo 02 ao longo do projeto. As avaliações foram realizadas para verificar a concordância dos artefatos desenvolvidos com a realidade de uso, identificar possíveis problemas de usabilidade e registrar oportunidades de melhoria.

Os relatos de avaliação estão organizados por técnica (Análise de Tarefas e Storyboards) e podem ser acessados individualmente pelos links disponíveis nas tabelas abaixo.

---

## Relatos da Avaliação da Análise de Tarefas
...
## Relatos da Avaliação dos Storyboards
...
## Relatos da Avaliação dos Protótipos de Papel
...
> <a id="REF1" href="#anchor_1">1.</a> BARBOSA, Simone et al. **Interação Humano-Computador e Experiência do Usuário**. Autopublicação — Leanpub, 2021.
...
Agradecemos à IA Generativa **Claude** (Anthropic) pelo suporte na elaboração deste documento. A ferramenta foi utilizada para auxiliar na estruturação do índice, na redação da introdução e na formatação das tabelas e hiperlinks. Todo o conteúdo técnico e as decisões de design foram realizados pelos integrantes da equipe; o Claude atuou como assistente de formatação e redação, sem interferir nas escolhas metodológicas do grupo.

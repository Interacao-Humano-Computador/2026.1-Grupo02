...
|:----------:|:-------------|
| Bryan | Criação do documento de protótipo de papel |

<div style="text-align: left">
<p>Tabela 1: Tabela de contribuição (Fonte: SMITH, Bryan).</p>
</div>
...
### Tarefa 1: Se Cadastrar Como Mesário Voluntario 
...
![Se Cadastrar Como Mesário Voluntario  1](../../img/ProtótipoPapel/ImgMesario-1.jpeg)
<div style="text-align: left">
<p>Imagem 1: Protótipo de Papel: [Cadastro como mesario] (Fonte: SMITH, Bryan).</p>
</div>

![Se Cadastrar Como Mesário Voluntario  2](../../img/ProtótipoPapel/ImgMesario-2.jpeg)

<div style="text-align: left">
<p>Imagem 2: Protótipo de Papel: [Cadastro como mesario] (Fonte: SMITH, Bryan).</p>
</div>

![Se Cadastrar Como Mesário Voluntario  3](../../img/ProtótipoPapel/ImgMesario-3.jpeg)

<div style="text-align: left">
<p>Imagem 3: Protótipo de Papel: [Cadastro como mesario] (Fonte: SMITH, Bryan).</p>
</div>

![Se Cadastrar Como Mesário Voluntario  4](../../img/ProtótipoPapel/ImgMesario-4.jpeg)

<div style="text-align: left">
<p>Imagem 4: Protótipo de Papel: [Cadastro como mesario] (Fonte: SMITH, Bryan).</p>
</div>
...
|:----:|:------:|:----------|:---------:|:-----------:|
| 07/06/2026 | 1.0 | Criação do documento | Bryan |  |

<div style="text-align: left">
<p>Tabela 1: Histórico de Versão (Fonte: SMITH, Bryan).</p>
</div>

...
|:----------:|:-------------|
| Guilherme | Criação do documento de protótipo de papel |
...
### Tarefa 1: Alterar local de votação
...
![ALterar Local de Votação 1](../../../../img/ProtótipoPapel/AVL1.png)
<div style="text-align: left">
<p>Imagem 1: Protótipo de Papel: [Alterar local de votação] (Fonte: CARVALHO, Guilherme).</p>
</div>

![ALterar Local de Votação 2](../../../../img/ProtótipoPapel/AVL2.png)

<div style="text-align: left">
<p>Imagem 2: Protótipo de Papel: [Alterar local de votação] (Fonte: CARVALHO, Guilherme).</p>
</div>

![ALterar Local de Votação 3](../../../../img/ProtótipoPapel/AVL3.png)

<div style="text-align: left">
<p>Imagem 3: Protótipo de Papel: [Alterar local de votação] (Fonte: CARVALHO, Guilherme).</p>
</div>

![ALterar Local de Votação 4](../../../../img/ProtótipoPapel/AVL4.png)

<div style="text-align: left">
<p>Imagem 4: Protótipo de Papel: [Alterar local de votação] (Fonte: CARVALHO, Guilherme).</p>
</div>

![ALterar Local de Votação 4](../../../../img/ProtótipoPapel/AVL5.png)

<div style="text-align: left">
<p>Imagem 5: Protótipo de Papel: [Alterar local de votação] (Fonte: CARVALHO, Guilherme).</p>
</div>

...
|:----:|:------:|:----------|:---------:|:-----------:|
| 01/05/2026 | 1.0 | Criação do cenário para agendamento precensial do TSE | Lucas Fujimoto | Luan Ludry |

---

## Cenário: Agendamento Urgente para Regularização de Cliente
...
|:----------:|:-------------|
| Lucas Fujimoto | Criação do cenário |
